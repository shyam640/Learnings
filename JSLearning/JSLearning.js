...
console.log(Math.pow(4,5));      // returns 1024
console.log(4**5);        // returns 1024
...
let convrsn_int_value = parseInt("2523");    
// or 
convrsn_int_value = +"2523";
console.log(convrsn_int_value);     // returns 2523 in integer type

let consvrsn_float_value = parseFloat("375.29");
// or
convrsn_float_value = +"375.29";
console.log(convrsn_float_value);   // returns 375.29 in float
...
// Want to sharp your mind with small small logics then do visit below given awesome github repo :
//           https://github.com/denysdovhan/wtfjs


// To learn more about ES6 and sharp that concept also do visit below link :
